...
export SERVICE=vault-autounseal

# NAMESPACE where the Vault service is running.
export NAMESPACE=vault-autounseal
...
export CSR_NAME=vault-csr-autounseal
...
DNS.5 = ${SERVICE}-0
DNS.6 = ${SERVICE}-0.${SERVICE}-internal
DNS.7 = ${SERVICE}-0.${NAMESPACE}
DNS.8 = ${SERVICE}-0.${NAMESPACE}.svc
DNS.9 = ${SERVICE}-0.${NAMESPACE}.svc.cluster.local
DNS.10 = ${SERVICE}-1
DNS.11 = ${SERVICE}-1.${SERVICE}-internal
DNS.12 = ${SERVICE}-1.${NAMESPACE}
DNS.13 = ${SERVICE}-1.${NAMESPACE}.svc
DNS.14 = ${SERVICE}-1.${NAMESPACE}.svc.cluster.local
DNS.15 = ${SERVICE}-2
DNS.16 = ${SERVICE}-2.${SERVICE}-internal
DNS.17 = ${SERVICE}-2.${NAMESPACE}
DNS.18 = ${SERVICE}-2.${NAMESPACE}.svc
DNS.19 = ${SERVICE}-2.${NAMESPACE}.svc.cluster.local
IP.1 = 127.0.0.1
EOF
